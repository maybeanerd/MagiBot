//definition of calculation of dice, use p(input) to use
...
msg.channel.send("Für Hilfe nutze "+bot.PREFIX+"!help roll.");
    ...
    help: 'Werfe Würfel',
ehelp:function(bot,msg){msg.channel.send("Lasse botnameTODO für dich würfeln. Dabei kannst du 3d6 + 12, 4*d12 + 3, d100 verwenden");
},
    admin: false,
};
